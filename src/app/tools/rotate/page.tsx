...
export default function RotatePage() {
  ...
  return (
    <ToolLayout title="Rotate PDF" description="Rotate all pages in a PDF by a specified angle.">
      ...
      />
      <div>
        <label className="block text-sm text-neutral-600 dark:text-neutral-400 mb-1">Rotation angle</label>
        <select
          className="border border-neutral-300 dark:border-neutral-700 rounded-lg px-3 py-2 text-sm bg-white dark:bg-neutral-900 text-neutral-900 dark:text-neutral-100 focus:outline-none focus:ring-2 focus:ring-neutral-900 dark:focus:ring-neutral-400"
          value={angle}
