...
export const metadata: Metadata = {
  ...
  description: "Get in touch with the iEditPDF team. Report bugs, request features, or just say hello.",
};
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-16">
      ...
      <p className="text-neutral-500 dark:text-neutral-400 mt-3 text-sm leading-relaxed max-w-2xl">
        Have a question, found a bug, or want to request a feature? We would love to hear from you.
        Since iEditPDF is a fully client-side tool, we do not collect any data - your message goes directly to us.
      </p>
      ...
      <div className="mt-10">
        ...
        <div className="mt-4 space-y-4 text-sm text-neutral-600 dark:text-neutral-400">
          <div>
            ...
            <p className="mt-0.5">
              <a href="mailto:avanish@tutamail.com" className="underline underline-offset-2 hover:text-neutral-900 dark:hover:text-neutral-100 transition-colors">
